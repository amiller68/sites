...
const projects: Project[] = [
  ...
  },
  {
    name: "pack",
    description:
      "Document management for AI agents. Write and organize Markdown docs with tags and links, then serve them to agents via MCP for contextual retrieval.",
    demo: "https://pack.krondor.org",
    language: "Rust",
  },
  {
    name: "jig",
